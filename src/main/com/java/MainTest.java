...
public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        TestBase backend = new BackendConfig();
        TestBase ui = new UIConfig();

        System.out.println(base.getAppName());
        System.out.println(backend.getAppName());
        System.out.println(ui.getAppName());


        System.out.println(base.testId);
        System.out.println(backend.testId);
        System.out.println(ui.testId);
        ...
        backend.initializeTestConfigurations();
        ui.initializeTestConfigurations();
        ...
        TestBase o1 = new TestBase();
        TestBase o2 = new TestBase();
        TestBase o3 = new BackendConfig();
        TestBase o4 = new BackendConfig();
        TestBase o5 = new UIConfig();
        TestBase o6 = new UIConfig();
